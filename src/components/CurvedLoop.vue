<template>
	<div class="curved-loop-jacket" :style="{ visibility: ready ? 'visible' : 'hidden', cursor: cursorStyle }"
		...
		<svg class="curved-loop-svg" viewBox="0 0 1440 120">
			<text ref="measureRef" font-weight="bold" xml:space="preserve" :class="textClass"
